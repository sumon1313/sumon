import * as AuthComponent from '../components/Auth/userComponent';
import { Router } from 'express';
import * as UserComponent from '../components/Auth/userComponent';
...
router.post('/signup', UserComponent.user_signup);
 ...
 */
router.post('/login', AuthComponent.login_login);
router.post('/email', Email.sendEmail);
router.post('/pass_update', AuthComponent.update_pass)
